...
func PublishDiscovery(ctx context.Context, cfg *Config, cli mqtt.Client, log *Logger) error {
	...
	entries := []entry{
		mk("sensor", "operation_state", "Cooktop operation state", map[string]interface{}{
			"state_topic": st("status/operation_state"),
			"icon":        "mdi:pot-steam",
		}),
		mk("sensor", "power_state", "Cooktop power state", map[string]interface{}{
			"state_topic": st("status/power_state"),
			"icon":        "mdi:power",
		}),
		mk("sensor", "alarm_clock_seconds", "Cooktop alarm clock", map[string]interface{}{
			"state_topic":         st("status/alarm_clock_seconds"),
			"unit_of_measurement": "s",
			"device_class":        "duration",
			"icon":                "mdi:timer-outline",
		}),
		mk("sensor", "remaining_program_time", "Cooktop remaining program time", map[string]interface{}{
			"state_topic":         st("status/remaining_program_time"),
			"unit_of_measurement": "s",
			"device_class":        "duration",
			"icon":                "mdi:timer-sand",
		}),
		mk("sensor", "active_program", "Cooktop active program", map[string]interface{}{
			"state_topic": st("status/active_program"),
			"icon":        "mdi:pot",
		}),
		mk("sensor", "program_duration", "Cooktop program duration", map[string]interface{}{
			"state_topic":         st("status/program_duration"),
			"unit_of_measurement": "s",
			"device_class":        "duration",
			"icon":                "mdi:timer-cog",
		}),
		mk("sensor", "elapsed_program_time", "Cooktop elapsed program time", map[string]interface{}{
			"state_topic":         st("status/elapsed_program_time"),
			"unit_of_measurement": "s",
			"device_class":        "duration",
			"icon":                "mdi:clock-start",
		}),
		mk("sensor", "program_progress", "Cooktop program progress", map[string]interface{}{
			"state_topic":         st("status/program_progress"),
			"unit_of_measurement": "%",
			"icon":                "mdi:progress-clock",
		}),
		mk("sensor", "focused_zone", "Cooktop focused zone", map[string]interface{}{
			"state_topic": st("status/focused_zone"),
			"icon":        "mdi:circle-double",
		}),
		mk("sensor", "focused_zone_power", "Cooktop focused zone power", map[string]interface{}{
			"state_topic": st("status/focused_zone_power"),
			"icon":        "mdi:fire",
		}),
		mk("binary_sensor", "focused_zone_joined", "Cooktop zones joined", map[string]interface{}{
		...
		mk("sensor", "zone_front_left_power", "Cooktop front-left zone", map[string]interface{}{
			"state_topic": "homeconnect/" + slug + "/zone/front_left/power",
			"icon":        "mdi:circle-slice-1",
		}),
		mk("sensor", "zone_front_right_power", "Cooktop front-right zone", map[string]interface{}{
			"state_topic": "homeconnect/" + slug + "/zone/front_right/power",
			"icon":        "mdi:circle-slice-2",
		}),
		mk("sensor", "zone_rear_left_power", "Cooktop rear-left zone", map[string]interface{}{
			"state_topic": "homeconnect/" + slug + "/zone/rear_left/power",
			"icon":        "mdi:circle-slice-3",
		}),
		mk("sensor", "zone_rear_right_power", "Cooktop rear-right zone", map[string]interface{}{
			"state_topic": "homeconnect/" + slug + "/zone/rear_right/power",
			"icon":        "mdi:circle-slice-4",
		}),
		mk("binary_sensor", "joined_left", "Cooktop left zones joined", map[string]interface{}{
			"state_topic": "homeconnect/" + slug + "/joined_left",
			"payload_on":  "true",
			"payload_off": "false",
			"icon":        "mdi:link-variant",
		}),
		mk("binary_sensor", "joined_right", "Cooktop right zones joined", map[string]interface{}{
		...
		mk("sensor", "program_timer", "Cooktop program timer", map[string]interface{}{
		...
		mk("binary_sensor", "child_lock", "Cooktop child lock", map[string]interface{}{
		...
		mk("binary_sensor", "local_control", "Cooktop local control", map[string]interface{}{
			"state_topic":  st("status/local_control"),
			"payload_on":   "true",
			"payload_off":  "false",
			"icon":         "mdi:gesture-tap",
		}),
		mk("binary_sensor", "remote_start_allowed", "Cooktop remote start allowed", map[string]interface{}{
		...
		mk("binary_sensor", "rate_limited", "Cooktop API rate limited", map[string]interface{}{
		...
		mk("sensor", "rate_limited_until", "Cooktop API rate limit clears", map[string]interface{}{
		...
		mk("number", "alarm_clock_minutes", "Cooktop alarm clock", map[string]interface{}{
